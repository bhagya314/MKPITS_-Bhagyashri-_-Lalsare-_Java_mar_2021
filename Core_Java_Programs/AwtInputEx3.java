//awt example to input stream
package Com.Mkpits.Java.AWT.AwtInputOutput_13May;
import java.io.*;
import java.awt.*;
import java.awt.event.*;
public class AwtInputEx3 extends Frame{
    Button b1,b2;
    Label l1,l2,l3;
    TextField tf,tf1;
    TextArea ta;
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    FileOutputStream fo = new
                            FileOutputStream("d://bhagya//fn.txt");
    ...
    public static void main(String[] args) {
        AwtInputEx3 ex=new AwtInputEx3();
    }
}

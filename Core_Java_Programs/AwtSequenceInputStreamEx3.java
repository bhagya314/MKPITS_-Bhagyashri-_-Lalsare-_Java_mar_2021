//equence Input Stream example
package Com.Mkpits.Java.AWT.AwtInputOutput_13May;
import java.io.*;
import java.awt.*;
import java.awt.event.*;
public class AwtSequenceInputStreamEx3 extends Frame{
    Button b1,b2;
    Label l1,l2,l3;
    TextField tf,tf1;
    TextArea ta;
    AwtSequenceInputStreamEx3() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    FileOutputStream fo = new
                            FileOutputStream("e://ekta//fn.txt");
    ...
    public static void main(String[] args) {
        AwtSequenceInputStreamEx3 ex=new AwtSequenceInputStreamEx3();
    }
}
